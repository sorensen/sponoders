...
(function() {
    ...
    Views.RoomMainView = Backbone.View.extend({
        ...
        render : function() {
            ...
            var sounds = [
                {name : 'drum1', type : 'drum'},
                {name : 'drum2', type : 'drum'},
                {name : 'drum3', type : 'drum'},
                {name : 'drum4', type : 'drum'},

                {name : 'blah1', type : 'blah'},
                {name : 'blah2', type : 'blah'},
                {name : 'blah3', type : 'blah'},
                {name : 'blah4', type : 'blah'}
            ];
        ...
        subscribe : function(online) {
            ...
            console.log('sub', this.view.model.users);
